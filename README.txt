...
Before start:
1. Create text file 'app_secret_key.txt' with secure secret key in it.
2. Add script file named 'ensure_admin.sql' in database_scripts catalogue.
...
3. Create vk_config.py file with configuration of your VK Callback API server inside it.
4. Import sqlite3 module and create_db function from main module and call it. This will create a database for your app.
